...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/ChoosePractice` | `/CompletedFlashcards` | `/ContentSelect` | `/FlashcardGame` | `/FlashcardSettings` | `/List` | `/SectionCard` | `/SectionList` | `/WriteGame` | `/WritePopup` | `/WriteSettings` | `/_sitemap` | `/features/flashcardSlice` | `/features/selectSlice` | `/features/store` | `/features/writeGameSlice` | `/utils/shuffleArray`;
