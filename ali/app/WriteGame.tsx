...
const WriteGame: React.FC = () => {
  ...
  const fetchDeck = async () => {
    // Using the sample deck instead of fetching from JSON
    dispatch(setDeck(shuffleArray(sampleDeck)));
  };
